...
namespace GMNumber {
	...
	//--- BY PADDING I MEAN DO U WANT TO SEE THE GRID REPRESENTATION IN SCREEN
	static constexpr bool IS_PADDING = true;
	//--------------------------------------------------------------------------------
	static constexpr float GRAVITY = 60.0f * 10.0f;// HERE 60 IS A MODIFIER AND 10 IS ACTUAL VALUE JUST LIKE IRL G OF 9.8 OR 10M/S
	...
	// For other masses, the terminal velocity can be calculated as: vt.x = 16000.0f / mass
	...
	// these is  the threshold for the object to be considered as stationary
	...
	static const sf::Vector2f COEFF_OF_RESTITUTION_FOR_BOUNCY_PATH(0.7f, 4.5f) ;
	...
	// this is a grid range ,means it checks n block out of player in all direction
